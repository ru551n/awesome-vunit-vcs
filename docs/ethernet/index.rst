...
The Ethernet family verifies designs with MII, RMII, GMII, RGMII, XGMII-family and AXI-Stream MAC client interfaces. Every interface has
...
.. list-table::
   ...
   * - Page
     - What's here
   * - :doc:`gmii`, :doc:`xgmii`, :doc:`mii`, :doc:`rgmii`, :doc:`rmii`, :doc:`axis_mac`
...
.. list-table::
   ...
   * - RMII
     - 10M, 100M
     - ``data(1 downto 0)``, ``dv``, ``er`` on a 50 MHz ``ref_clk``
     - :doc:`rmii`
   * - GMII
     - 1G, 2.5G overclocked
   ...
   * - RGMII
     - 10M, 100M, 1G
     - ``data(3 downto 0)``, ``ctl`` on both clock edges
     - :doc:`rgmii`
   * - XGMII family
     - 2.5G to 400G
