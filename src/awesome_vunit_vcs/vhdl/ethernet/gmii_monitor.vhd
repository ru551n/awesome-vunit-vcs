...
--
-- Passive GMII monitor: samples one direction of a GMII interface
...
-- in its handle, the monitor instantiates a gmii_protocol_checker on the same
...
begin
  ...
  protocol_checker_gen : if get_protocol_checker(monitor) /= null_gmii_protocol_checker generate
    protocol_checker_inst : entity work.gmii_protocol_checker
      generic map (
