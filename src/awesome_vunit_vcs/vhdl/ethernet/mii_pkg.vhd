...
package mii_pkg is
  ...
  procedure get_frame_count (signal net : inout network_t; monitor : mii_monitor_t; variable count : out natural);
  procedure log_statistics (signal net : inout network_t; monitor : mii_monitor_t; log_level : log_level_t := info);
  ...
  procedure stop_capture (signal net : inout network_t; monitor : mii_monitor_t);
  ...
  -- (:vhdl:`mii_pkg.get_protocol_checker`). A protocol check on a monitor
  ...
  procedure reset (signal net : inout network_t; source : mii_source_t);
  procedure reset (signal net : inout network_t; monitor : mii_monitor_t; clear_statistics : boolean := false);
  procedure reset (signal net : inout network_t; protocol_checker : mii_protocol_checker_t);
...
package body mii_pkg is
  ...
  begin
    ...
    return (
      ...
      p_cfg => new_ethernet_cfg(interface => mii, link_rate_mbps => link_rate_mbps)
    );
  end;
  ...
  procedure get_frame_count (signal net : inout network_t; monitor : mii_monitor_t; variable count : out natural) is
  begin

    get_frame_count(net, as_ethernet_monitor(monitor), count);
  end;

  procedure log_statistics (signal net : inout network_t; monitor : mii_monitor_t; log_level : log_level_t := info) is
  begin
  ...
  procedure stop_capture (signal net : inout network_t; monitor : mii_monitor_t) is
  begin
  ...
  procedure reset (signal net : inout network_t; source : mii_source_t) is
  begin

    reset(net, as_ethernet_source(source));
  end;

  procedure reset (signal net : inout network_t; monitor : mii_monitor_t; clear_statistics : boolean := false) is
  begin

    reset(net, as_ethernet_monitor(monitor), clear_statistics);
  end;

  procedure reset (signal net : inout network_t; protocol_checker : mii_protocol_checker_t) is
  begin
