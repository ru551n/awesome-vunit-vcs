...
--
-- Conformance of the MII source, monitor and protocol checker with the VUnit
...
architecture tb of tb_mii_vci is
  ...
  constant source : mii_source_t := new_mii_source;
  ...
  constant monitor : mii_monitor_t := new_mii_monitor(
    protocol_checker => default_mii_protocol_checker, id => get_id("tb_mii_vci:monitor")
  );
  ...
  constant ignoring_protocol_checker : mii_protocol_checker_t := new_mii_protocol_checker(
...
begin
  ...
  main : process
    ...
    variable custom_source : mii_source_t;
    variable custom_monitor : mii_monitor_t;
    ...
    while test_suite loop
      if run("test_default_ids_are_enumerated_under_the_vc_name") then
        check_default_identity(
          get_id(source), get_logger(source), get_actor(source), get_checker(source), "mii_source"
        );
        check_default_identity(
          get_id(default_monitor), get_logger(default_monitor), get_actor(default_monitor),
          get_checker(default_monitor), "mii_monitor"
        );
        check_default_identity(
          get_id(protocol_checker), get_logger(protocol_checker), get_actor(protocol_checker),
          get_checker(protocol_checker), "mii_protocol_checker"
        );
        ...
        check_equal(full_name(get_id(monitor)), "tb_mii_vci:monitor");
  ...
  second_source_inst : entity awesome_vunit_vcs.mii_source
    generic map (
  ...
  ignoring_source_inst : entity awesome_vunit_vcs.mii_source
    generic map (
  ...
  default_monitor_inst : entity awesome_vunit_vcs.mii_monitor
    generic map (
  ...
  second_default_monitor_inst : entity awesome_vunit_vcs.mii_monitor
    generic map (
  ...
  ignoring_monitor_inst : entity awesome_vunit_vcs.mii_monitor
    generic map (
  ...
  protocol_checker_inst : entity awesome_vunit_vcs.mii_protocol_checker
    generic map (
  ...
  second_protocol_checker_inst : entity awesome_vunit_vcs.mii_protocol_checker
    generic map (
  ...
  ignoring_protocol_checker_inst : entity awesome_vunit_vcs.mii_protocol_checker
    generic map (
