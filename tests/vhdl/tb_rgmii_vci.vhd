...
architecture tb of tb_rgmii_vci is
  ...
  constant monitor : rgmii_monitor_t :=
    new_rgmii_monitor(protocol_checker => default_rgmii_protocol_checker, id => get_id("tb_rgmii_vci:monitor"));
  ...
  constant ignoring_protocol_checker : rgmii_protocol_checker_t :=
    new_rgmii_protocol_checker(unexpected_msg_type_policy => ignore);
