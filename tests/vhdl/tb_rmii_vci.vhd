...
architecture tb of tb_rmii_vci is
  ...
  signal second_dv : std_ulogic;
  signal second_er : std_ulogic;
  signal ignoring_dv : std_ulogic;
  signal ignoring_er : std_ulogic;
  ...
  constant monitor : rmii_monitor_t :=
    new_rmii_monitor(protocol_checker => default_rmii_protocol_checker, id => get_id("tb_rmii_vci:monitor"));
  ...
  constant ignoring_protocol_checker : rmii_protocol_checker_t :=
    new_rmii_protocol_checker(unexpected_msg_type_policy => ignore);
